 ...
 *
 * @generated from test/test_zgetrs.c, normal z -> s, Sat Jul 22 09:25:31 2017
 *
 **/
#include "test.h"
#include "flops.h"
...
void test_sgetrs(param_value_t param[], bool run)
{
    ...
    // Run GETRF
    //================================================================
    plasma_sgetrf(n, n, A, lda, ipiv);

    //================================================================
    // Run and time PLASMA.
    //================================================================
    plasma_time_t start = omp_get_wtime();
    plasma_sgetrs(n, nrhs, A, lda, ipiv, B, ldb);
    plasma_time_t stop = omp_get_wtime();
    plasma_time_t time = stop-start;

    param[PARAM_TIME].d = time;
    param[PARAM_GFLOPS].d = flops_sgetrs(n, nrhs) / time / 1e9;
