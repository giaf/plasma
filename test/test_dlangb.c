 ...
 *
 * @generated from test/test_zlangb.c, normal z -> d, Sat Jul 22 09:25:37 2017
 *
 **/
...
#define REAL
double dlangb_(char *, int *, int *, int *, double *, int *, double *);
 //   double value = plasma_dlangb(norm, m, n, kl, ku,  AB, ldab);
double plasma_dlangb(plasma_enum_t, int, int, int, int, double *, int);
/***************************************************************************//**
 *
 * @brief Tests DLANGB.
 *
...
void test_dlangb(param_value_t param[], bool run)
{
	...
	case PlasmaFrobeniusNorm:
        ...
        double valueRef =
            ...
            //dlange_(cnorm, &kuu, &n, ABref+kl, &ldab, NULL);
            dlangb_(cnorm, &n,&kl, &ku, ABref+kl, &ldab, workspace);
