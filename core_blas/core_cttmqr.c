 ...
 *
 * @generated from core_blas/core_zttmqr.c, normal z -> c, Sat Jul 22 09:24:47 2017
 *
 **/
 ...
 *         core_cttqrt in the first k columns of its array argument V.
 *
 * @param[in] ldv
                      ...
                      plasma_complex32_t *work, int ldwork)
{
    ...
    for (int i = i1; i > -1 && i < k; i += i3) {
        ...
        // Apply H or H^H (NOTE: core_cparfb used to be core_zttrfb).
        core_cparfb(side, trans, PlasmaForward, PlasmaColumnwise,
                    mi, ni, mi2, ni2, kb, l,
                    &A1[lda1*jc+ic], lda1,
                    A2, lda2,
                    &V[ldv*i], ldv,
                     ...
                     plasma_sequence_t *sequence, plasma_request_t *request)
{
                     ...
                     depend(in:T[0:ib*k])
    {
        if (sequence->status == PlasmaSuccess) {
            ...
            // Call the kernel.
            int info = core_cttmqr(side, trans,
                                   m1, n1, m2, n2, k, ib,
                                   A1, lda1,
                                   A2, lda2,
                                   V,  ldv,
