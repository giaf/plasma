 ...
 *
 * @generated from core_blas/core_zttlqt.c, normal z -> s, Sat Jul 22 09:24:43 2017
 *
 **/
                ...
                float *work)
{
    ...
    //core_slaset(PlasmaGeneral, ib, m, 0.0, 0.0, T, ldt);
    ...
    for (int ii = 0; ii < m; ii += ib) {
        ...
        for (int i = 0; i < sb; i++) {
            ...
            LAPACKE_slacgv_work(1, &A1[lda1*j+j], lda1);
#endif
