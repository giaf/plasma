 ...
 *
 * @generated from core_blas/core_zparfb.c, normal z -> s, Sat Jul 22 09:24:49 2017
 *
 **/
 ...
 *  or its transpose H^T to a rectangular matrix formed by
 ...
 ******************************************************************************/
__attribute__((weak))
int core_sparfb(plasma_enum_t side, plasma_enum_t trans,
                      ...
                      float *work, int ldwork)
{
    ...
    if (direct == PlasmaForward) {
        ...
        //=============================
        if (side == PlasmaLeft) {
            // Form  H * A  or  H^T * A  where  A = ( A1 )
            //                                      ( A2 )

            // W = A1 + op(V) * A2
            core_spamm(PlasmaW, PlasmaLeft, storev,
                       k, n1, m2, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
            ...
            // A2 = A2 - op(V) * W
            // W = V * W, A2 = A2 - W
            core_spamm(PlasmaA2, PlasmaLeft, storev,
                       m2, n2, k, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
        ...
        //==============================
            ...
            // Form  H * A  or  H^T * A  where A  = ( A1 A2 )

            // W = A1 + A2 * op(V)
            core_spamm(PlasmaW, PlasmaRight, storev,
                       m1, k, n2, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
            ...
            // A2 = A2 - W * op(V)
            // W = W * V^T, A2 = A2 - W
            core_spamm(PlasmaA2, PlasmaRight, storev,
                       m2, n2, k, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
