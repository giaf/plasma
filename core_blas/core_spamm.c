 ...
 *
 * @generated from core_blas/core_zpamm.c, normal z -> s, Sat Jul 22 09:24:53 2017
 *
 **/
...
static inline int core_spamm_a2(plasma_enum_t side, plasma_enum_t trans,
                                plasma_enum_t uplo,
...
static inline int core_spamm_w(plasma_enum_t side, plasma_enum_t trans,
                               plasma_enum_t uplo,
                               int m, int n, int k, int l, int vi2, int vi3,
 ...
 ******************************************************************************/
__attribute__((weak))
int core_spamm(plasma_enum_t op, plasma_enum_t side, plasma_enum_t storev,
...
/******************************************************************************/
static inline int core_spamm_w(
...
/******************************************************************************/
static inline int core_spamm_a2(
        plasma_enum_t side, plasma_enum_t trans, plasma_enum_t uplo,
        int m, int n, int k, int l, int vi2, int vi3,
              float *A2, int lda2,
        const float *V,  int ldv,
