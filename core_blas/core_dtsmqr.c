 ...
 *
 * @generated from core_blas/core_ztsmqr.c, normal z -> d, Sat Jul 22 09:24:52 2017
 *
 **/
                      ...
                      double *work, int ldwork)
{
    ...
    for (int i = i1; i > -1 && i < k; i += i3) {
        ...
        // Apply H or H^T (NOTE: core_dparfb used to be core_ztsrfb).
                     ...
                     plasma_sequence_t *sequence, plasma_request_t *request)
{
                     ...
                     depend(in:T[0:ib*k])
    {
        if (sequence->status == PlasmaSuccess) {
            ...
            // Call the kernel.
            int info = core_dtsmqr(side, trans,
                                   m1, n1, m2, n2, k, ib,
                                   A1, lda1,
                                   A2, lda2,
                                   V,  ldv,
