 ...
 *
 * @generated from core_blas/core_zlacpy_band.c, normal z -> s, Sat Jul 22 09:24:51 2017
 *
 **/
 ...
 * @ingroup core_float
 *
 *  core_slacpy copies a sub-block A of a band matrix stored in LAPACK's band format
                                        ...
                                        float *B, int ldb)
{
    ...
    for (j = j_start; j < j_end; j++) {
        ...
        if (uplo == PlasmaGeneral) {
            ...
            // +nb because we use sgetrf on panel and pivot back within the panel.
                                            ...
                                            float *B, int ldb)
{
    ...
    core_slacpy_lapack2tile_band(uplo,
                                 it, jt, m, n, nb, kl, ku,
                                 A, lda,
                                 B, ldb);
}
 ...
 * @ingroup core_float
 *
 *  core_slacpy copies all or part of a two-dimensional matrix A to another
 *  matrix B
 *
 *******************************************************************************
 *
                                            ...
                                            float *A, int lda)
{
    ...
    core_slacpy_tile2lapack_band(uplo,
                                 it, jt, m, n, nb, kl, ku,
                                 B, ldb,
                                 A, lda);
}
