 ...
 *
 * @generated from core_blas/core_ztslqt.c, normal z -> c, Sat Jul 22 09:24:41 2017
 *
 **/
                ...
                plasma_complex32_t *work)
{
    ...
    for (int ii = 0; ii < m; ii += ib) {
...
#endif
            LAPACKE_clarfg_work(n+1, &A1[lda1*(ii+i)+ii+i], &A2[ii+i], lda2,
                                &tau[ii+i]);
        ...
        if (m > ii+sb) {
            core_ctsmlq(PlasmaRight, Plasma_ConjTrans,
