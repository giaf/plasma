 ...
 *
 * @generated from core_blas/core_zpamm.c, normal z -> c, Sat Jul 22 09:24:52 2017
 *
 **/
...
static inline int core_cpamm_a2(plasma_enum_t side, plasma_enum_t trans,
                                plasma_enum_t uplo,
...
static inline int core_cpamm_w(plasma_enum_t side, plasma_enum_t trans,
                               plasma_enum_t uplo,
                               int m, int n, int k, int l, int vi2, int vi3,
 ...
 ******************************************************************************/
__attribute__((weak))
int core_cpamm(plasma_enum_t op, plasma_enum_t side, plasma_enum_t storev,
...
/******************************************************************************/
static inline int core_cpamm_w(
              ...
              plasma_complex32_t *W,  int ldw)
{
    ...
    if (side == PlasmaLeft) {
        if ((trans == Plasma_ConjTrans && uplo == CblasUpper) ||
            ...
            // W = A1 + W
            for (int j = 0; j < n; j++) {
                cblas_caxpy(m, CBLAS_SADDR(zone),
                            &A1[lda1*j], 1,
                            &W[ldw*j], 1);
            }
        }
...
/******************************************************************************/
static inline int core_cpamm_a2(
        plasma_enum_t side, plasma_enum_t trans, plasma_enum_t uplo,
        int m, int n, int k, int l, int vi2, int vi3,
              plasma_complex32_t *A2, int lda2,
        const plasma_complex32_t *V,  int ldv,
              plasma_complex32_t *W,  int ldw)
{
    ...
    if (side == PlasmaLeft) {
        if ((trans == Plasma_ConjTrans && uplo == CblasUpper) ||
            ...
            // A2_2 = A2_2 - W_1
            for (int j = 0; j < n; j++) {
                cblas_caxpy(l, CBLAS_SADDR(zmone),
                            &W[ldw*j], 1,
                            &A2[lda2*j+(m-l)], 1);
            }
