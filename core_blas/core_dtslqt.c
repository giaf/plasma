 ...
 *
 * @generated from core_blas/core_ztslqt.c, normal z -> d, Sat Jul 22 09:24:41 2017
 *
 **/
                ...
                double *work)
{
    ...
    for (int ii = 0; ii < m; ii += ib) {
...
#endif
            LAPACKE_dlarfg_work(n+1, &A1[lda1*(ii+i)+ii+i], &A2[ii+i], lda2,
                                &tau[ii+i]);
        ...
        if (m > ii+sb) {
            core_dtsmlq(PlasmaRight, PlasmaTrans,
