 ...
 *
 * @generated from core_blas/core_zunmlq.c, normal z -> s, Sat Jul 22 09:24:43 2017
 *
 **/
 ...
 *        Q = H(k) . . . H(2) H(1)
 *    \f]
 *  as returned by core_sgelqt. Q is of order m if side = PlasmaLeft
                     ...
                     plasma_sequence_t *sequence, plasma_request_t *request)
{
                     ...
                     depend(inout:C[0:ldc*n])
    {
        if (sequence->status == PlasmaSuccess) {
            ...
            // Call the kernel.
            int info = core_sormlq(side, trans,
                                   m, n, k, ib,
                                   A, lda,
                                   T, ldt,
                                   C, ldc,
