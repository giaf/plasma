 ...
 *
 * @generated from core_blas/core_zlacpy_band.c, normal z -> c, Sat Jul 22 09:24:50 2017
 *
 **/
 ...
 *
 *  core_clacpy copies a sub-block A of a band matrix stored in LAPACK's band format
                                            ...
                                            plasma_complex32_t *B, int ldb)
{
    ...
    core_clacpy_lapack2tile_band(uplo,
                                 it, jt, m, n, nb, kl, ku,
                                 A, lda,
                                 B, ldb);
}
 ...
 * @ingroup core_plasma_complex32_t
 *
 *  core_clacpy copies all or part of a two-dimensional matrix A to another
 *  matrix B
 *
 *******************************************************************************
 *
                                            ...
                                            plasma_complex32_t *A, int lda)
{
    ...
    core_clacpy_tile2lapack_band(uplo,
                                 it, jt, m, n, nb, kl, ku,
                                 B, ldb,
                                 A, lda);
}
