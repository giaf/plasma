 ...
 *
 * @generated from core_blas/core_ztsmlq.c, normal z -> s, Sat Jul 22 09:24:50 2017
 *
 **/
                      ...
                      float *work, int ldwork)
{
    ...
    for (int i = i1; i > -1 && i < k; i += i3) {
        ...
        // Apply H or H^T.
        core_sparfb(side, trans, PlasmaForward, PlasmaRowwise,
                    mi, ni, m2, n2, kb, 0,
                    &A1[lda1*jc+ic], lda1,
                    A2, lda2,
                    &V[i], ldv,
                     ...
                     plasma_sequence_t *sequence, plasma_request_t *request)
{
                     ...
                     depend(in:T[0:ib*k])
    {
        if (sequence->status == PlasmaSuccess) {
            ...
            // Call the kernel.
            int info = core_stsmlq(side, trans,
                                   m1, n1, m2, n2, k, ib,
                                   A1, lda1,
                                   A2, lda2,
                                   V,  ldv,
            ...
            if (info != PlasmaSuccess) {
                plasma_error("core_stsmlq() failed");
