 ...
 *
 * @generated from core_blas/core_zparfb.c, normal z -> c, Sat Jul 22 09:24:49 2017
 *
 **/
 ...
 ******************************************************************************/
__attribute__((weak))
int core_cparfb(plasma_enum_t side, plasma_enum_t trans,
                      ...
                      plasma_complex32_t *work, int ldwork)
{
    ...
    if (direct == PlasmaForward) {
        ...
        if (side == PlasmaLeft) {
            ...
            // W = A1 + op(V) * A2
            core_cpamm(PlasmaW, PlasmaLeft, storev,
                       k, n1, m2, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
            ...
            // A1 = A1 - W
            for (int j = 0; j < n1; j++) {
                cblas_caxpy(k, CBLAS_SADDR(zmone),
                            &work[ldwork*j], 1,
                            &A1[lda1*j], 1);
            }
            ...
            // A2 = A2 - op(V) * W
            // W = V * W, A2 = A2 - W
            core_cpamm(PlasmaA2, PlasmaLeft, storev,
                       m2, n2, k, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
        ...
        //==============================
            ...
            // W = A1 + A2 * op(V)
            core_cpamm(PlasmaW, PlasmaRight, storev,
                       m1, k, n2, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
            ...
            // A1 = A1 - W
            for (int j = 0; j < k; j++) {
                cblas_caxpy(m1, CBLAS_SADDR(zmone),
                            &work[ldwork*j], 1,
                            &A1[lda1*j], 1);
            }
            ...
            // A2 = A2 - W * op(V)
            // W = W * V^H, A2 = A2 - W
            core_cpamm(PlasmaA2, PlasmaRight, storev,
                       m2, n2, k, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
