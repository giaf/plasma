 ...
 *
 * @generated from core_blas/core_zttmlq.c, normal z -> c, Sat Jul 22 09:24:56 2017
 *
 **/
 ...
 *         core_cttlqt in the first k rows of its array argument V.
 *
 * @param[in] ldv
                     ...
                     plasma_sequence_t *sequence, plasma_request_t *request)
{
                     ...
                     depend(in:T[0:ib*k])
    {
        if (sequence->status == PlasmaSuccess) {
            ...
            // Call the kernel.
            int info = core_cttmlq(side, trans,
                                   m1, n1, m2, n2, k, ib,
                                   A1, lda1,
                                   A2, lda2,
                                   V,  ldv,
            ...
            if (info != PlasmaSuccess) {
                plasma_error("core_cttmlq() failed");
