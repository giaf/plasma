 ...
 *
 * @generated from core_blas/core_zlacpy_band.c, normal z -> d, Sat Jul 22 09:24:50 2017
 *
 **/
 ...
 * @ingroup core_double
 *
 *  core_dlacpy copies a sub-block A of a band matrix stored in LAPACK's band format
                                            ...
                                            double *B, int ldb)
{
    ...
    core_dlacpy_lapack2tile_band(uplo,
                                 it, jt, m, n, nb, kl, ku,
                                 A, lda,
                                 B, ldb);
}
 ...
 * @ingroup core_double
 *
 *  core_dlacpy copies all or part of a two-dimensional matrix A to another
 *  matrix B
 *
 *******************************************************************************
 *
                                            ...
                                            double *A, int lda)
{
    ...
    core_dlacpy_tile2lapack_band(uplo,
                                 it, jt, m, n, nb, kl, ku,
                                 B, ldb,
                                 A, lda);
}
