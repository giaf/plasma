 ...
 *
 * @generated from core_blas/core_zparfb.c, normal z -> d, Sat Jul 22 09:24:49 2017
 *
 **/
 ...
 ******************************************************************************/
__attribute__((weak))
int core_dparfb(plasma_enum_t side, plasma_enum_t trans,
                      ...
                      double *work, int ldwork)
{
    ...
    if (direct == PlasmaForward) {
        ...
        if (side == PlasmaLeft) {
            ...
            // W = A1 + op(V) * A2
            core_dpamm(PlasmaW, PlasmaLeft, storev,
                       k, n1, m2, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
            ...
            // A2 = A2 - op(V) * W
            // W = V * W, A2 = A2 - W
            core_dpamm(PlasmaA2, PlasmaLeft, storev,
                       m2, n2, k, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
        ...
        //==============================
            ...
            // W = A1 + A2 * op(V)
            core_dpamm(PlasmaW, PlasmaRight, storev,
                       m1, k, n2, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
            ...
            // A2 = A2 - W * op(V)
            // W = W * V^T, A2 = A2 - W
            core_dpamm(PlasmaA2, PlasmaRight, storev,
                       m2, n2, k, l,
                       A1,   lda1,
                       A2,   lda2,
                       V,    ldv,
