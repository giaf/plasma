 ...
 *
 * @generated from core_blas/core_zunmqr.c, normal z -> c, Sat Jul 22 09:24:40 2017
 *
 **/
 ...
 *        Q = H(1) H(2) ... H(k)
 *    \f]
 *  as returned by core_cgeqrt. Q is of order m if side = PlasmaLeft
 ...
 *         as returned by core_cgeqrt in the first k columns of its
 *         array argument A.
 *
 * @param[in] lda
                     ...
                     plasma_sequence_t *sequence, plasma_request_t *request)
{
                     ...
                     depend(inout:C[0:ldc*n])
    {
        if (sequence->status == PlasmaSuccess) {
            ...
            // Call the kernel.
            int info = core_cunmqr(side, trans,
                                   m, n, k, ib,
                                   A, lda,
                                   T, ldt,
                                   C, ldc,
