 ...
 *
 * @generated from include/core_blas_z.h, normal z -> d, Sat Jul 22 08:53:38 2017
 *
 **/
...
void core_dgetrf(plasma_desc_t A, int *ipiv, int ib, int rank, int size,
                 volatile int *max_idx, volatile double *max_val,
                 volatile int *info, plasma_barrier_t *barrier);

int core_dsygst(int itype, plasma_enum_t uplo,
                int n,
                double *A, int lda,
                double *B, int ldb);
...
void core_dgeswp(plasma_enum_t colrow,
...
void core_omp_dsygst(int itype, plasma_enum_t uplo,
                     int n,
                     double *A, int lda,
                     double *B, int ldb,
                     plasma_sequence_t *sequence, plasma_request_t *request);
