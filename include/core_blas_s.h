 ...
 *
 * @generated from include/core_blas_z.h, normal z -> s, Sat Jul 22 08:53:38 2017
 *
 **/
...
void core_sgetrf(plasma_desc_t A, int *ipiv, int ib, int rank, int size,
                 volatile int *max_idx, volatile float *max_val,
                 volatile int *info, plasma_barrier_t *barrier);

int core_ssygst(int itype, plasma_enum_t uplo,
                int n,
                float *A, int lda,
                float *B, int ldb);
...
void core_slacpy(plasma_enum_t uplo, plasma_enum_t transa,
                 int m, int n,
                 const float *A, int lda,
                       float *B, int ldb);
...
void core_sgeswp(plasma_enum_t colrow,
...
void core_omp_ssygst(int itype, plasma_enum_t uplo,
                     int n,
                     float *A, int lda,
                     float *B, int ldb,
                     plasma_sequence_t *sequence, plasma_request_t *request);
...
void core_omp_slacpy(plasma_enum_t uplo, plasma_enum_t transa,
                     int m, int n,
                     const float *A, int lda,
                           float *B, int ldb,
                     plasma_sequence_t *sequence, plasma_request_t *request);
