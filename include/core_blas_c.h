 ...
 *
 * @generated from include/core_blas_z.h, normal z -> c, Sat Jul 22 08:53:38 2017
 *
 **/
...
void core_cgetrf(plasma_desc_t A, int *ipiv, int ib, int rank, int size,
                 volatile int *max_idx, volatile plasma_complex32_t *max_val,
                 volatile int *info, plasma_barrier_t *barrier);

int core_chegst(int itype, plasma_enum_t uplo,
                int n,
                plasma_complex32_t *A, int lda,
...
void core_clacpy(plasma_enum_t uplo, plasma_enum_t transa,
                 int m, int n,
                 const plasma_complex32_t *A, int lda,
                       plasma_complex32_t *B, int ldb);
...
void core_cgeswp(plasma_enum_t colrow,
...
void core_omp_chegst(int itype, plasma_enum_t uplo,
                     int n,
                     plasma_complex32_t *A, int lda,
                     plasma_complex32_t *B, int ldb,
                     plasma_sequence_t *sequence, plasma_request_t *request);
...
void core_omp_clacpy(plasma_enum_t uplo, plasma_enum_t transa,
                     int m, int n,
                     const plasma_complex32_t *A, int lda,
                           plasma_complex32_t *B, int ldb,
                     plasma_sequence_t *sequence, plasma_request_t *request);
