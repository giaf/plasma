 ...
 *
 * @generated from compute/zsymm.c, normal z -> s, Sat Jul 22 09:24:13 2017
 *
 **/
 ...
 *
 ******************************************************************************/
int plasma_ssymm(plasma_enum_t side, plasma_enum_t
                 uplo, int m, int n,
                 ...
                 float beta,  float *pC, int ldc)
{
    ...
    // Tune parameters.
    if (plasma->tuning)
        plasma_tune_symm(plasma, PlasmaRealFloat, m, n);
 ...
 *  Non-blocking tile version of plasma_ssymm().
