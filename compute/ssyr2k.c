 ...
 *
 * @generated from compute/zsyr2k.c, normal z -> s, Sat Jul 22 09:24:27 2017
 *
 **/
                  ...
                  float beta,  float *pC, int ldc)
{
    ...
    // Tune parameters.
    if (plasma->tuning)
        plasma_tune_syr2k(plasma, PlasmaRealFloat, n, k);
 ...
 *  Non-blocking tile version of plasma_ssyr2k().
