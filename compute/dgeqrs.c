 ...
 *
 * @generated from compute/zgeqrs.c, normal z -> d, Sat Jul 22 09:24:34 2017
 *
 **/
                  ...
                  double *pB, int ldb)
{
    ...
    #pragma omp master
    {
        ...
        plasma_omp_dgeqrs(A, T, B, work, &sequence, &request);
 ...
 *  Non-blocking tile version of plasma_dgeqrs().
