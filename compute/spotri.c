 ...
 *
 * @generated from compute/zpotri.c, normal z -> s, Sat Jul 22 09:24:27 2017
 *
 **/
                  ...
                  float *pA, int lda)
{
    ...
    // Tune parameters.
    if (plasma->tuning)
        plasma_tune_trtri(plasma, PlasmaRealFloat, n);
    ...
    #pragma omp master
    {
        ...
        // Perform computation.
        plasma_omp_spotri(uplo, A, &sequence, &request);
