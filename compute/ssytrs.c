 ...
 *
 * @generated from compute/zhetrs.c, normal z -> s, Sat Jul 22 09:24:23 2017
 *
 **/
                  ...
                  float *pB,  int ldb)
{
    ...
    #pragma omp master
    {
        ...
        plasma_omp_ssytrs(uplo, A, ipiv, T, ipiv2, B, &sequence, &request);
    }
 ...
 *  Non-blocking tile version of plasma_ssytrs().
