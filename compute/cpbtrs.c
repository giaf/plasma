 ...
 *
 * @generated from compute/zpbtrs.c, normal z -> c, Sat Jul 22 09:24:32 2017
 *
 **/
                  ...
                  plasma_complex32_t *pB,  int ldb)
{
    ...
    #pragma omp master
    {
        ...
        plasma_omp_cpbtrs(uplo, AB, B, &sequence, &request);
 ...
 *  Non-blocking tile version of plasma_cpbtrs().
