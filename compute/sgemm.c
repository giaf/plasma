 ...
 *
 * @generated from compute/zgemm.c, normal z -> s, Sat Jul 22 09:24:34 2017
 *
 **/
                 ...
                 float beta,  float *pC, int ldc)
{
    ...
    // Tune parameters.
    if (plasma->tuning)
        plasma_tune_gemm(plasma, PlasmaRealFloat, m, n, k);
    ...
    #pragma omp master
    {
        ...
        plasma_omp_sgemm(transa, transb,
                         alpha, A,
                                B,
                         beta,  C,
                         &sequence, &request);
 ...
 *  Non-blocking tile version of plasma_sgemm().
