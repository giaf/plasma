 ...
 *
 * @generated from compute/pzgeswp.c, normal z -> c, Sat Jul 22 09:24:29 2017
 *
 **/
    ...
    if (colrow == PlasmaRowwise) {
        for (int n = 0; n < A.nt; n++) {
                             ...
                             depend (inout:a10[0:lda10*nva10])
            {
                ...
                core_cgeswp(colrow, view, 1, A.m, ipiv, incx);
            }
        ...
        for (int m = 0; m < A.mt; m++) {
                             ...
                             depend (inout:a01[0])
            {
                ...
                core_cgeswp(colrow, view, 1, A.n, ipiv, incx);
            }
