 ...
 *
 * @generated from compute/zpbtrf.c, normal z -> s, Sat Jul 22 09:24:25 2017
 *
 **/
                  ...
                  float *pAB, int ldab)
{
    ...
    #pragma omp master
    {
        ...
        plasma_omp_spbtrf(uplo, AB, &sequence, &request);
 ...
 *  matrix.
 *  Non-blocking tile version of plasma_spbtrf().
