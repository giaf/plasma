 ...
 *
 * @generated from compute/zpotrs.c, normal z -> c, Sat Jul 22 09:24:18 2017
 *
 **/
                  ...
                  plasma_complex32_t *pB, int ldb)
{
    ...
    #pragma omp master
    {
        ...
        plasma_omp_cpotrs(uplo, A, B, &sequence, &request);
 ...
 *  Non-blocking tile version of plasma_cpotrs().
