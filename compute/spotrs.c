 ...
 *
 * @generated from compute/zpotrs.c, normal z -> s, Sat Jul 22 09:24:17 2017
 *
 **/
                  ...
                  float *pB, int ldb)
{
    ...
    #pragma omp master
    {
        ...
        plasma_omp_spotrs(uplo, A, B, &sequence, &request);
 ...
 *  Non-blocking tile version of plasma_spotrs().
