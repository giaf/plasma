 ...
 *
 * @generated from compute/zsyrk.c, normal z -> s, Sat Jul 22 09:24:24 2017
 *
 **/
                 ...
                 float beta,  float *pC, int ldc)
{
    ...
    // Tune parameters.
    if (plasma->tuning)
        plasma_tune_syrk(plasma, PlasmaRealFloat, n, k);
 ...
 *  Non-blocking tile version of plasma_ssyrk().
