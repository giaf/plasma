 ...
 *
 * @generated from compute/zpotrs.c, normal z -> d, Sat Jul 22 09:24:17 2017
 *
 **/
                  ...
                  double *pB, int ldb)
{
    ...
    #pragma omp master
    {
        ...
        plasma_omp_dpotrs(uplo, A, B, &sequence, &request);
 ...
 *  Non-blocking tile version of plasma_dpotrs().
