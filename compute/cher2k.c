 ...
 *
 * @generated from compute/zher2k.c, normal z -> c, Sat Jul 22 09:24:14 2017
 *
 **/
                  ...
                  float beta,              plasma_complex32_t *pC, int ldc)
{
    ...
    // Tune parameters.
    if (plasma->tuning)
        plasma_tune_syr2k(plasma, PlasmaComplexFloat, n, k);
 ...
 *  Non-blocking tile version of plasma_cher2k().
