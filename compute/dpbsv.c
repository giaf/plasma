 ...
 *
 * @generated from compute/zpbsv.c, normal z -> d, Sat Jul 22 09:24:31 2017
 *
 **/
                 ...
                 double *pB,  int ldb)
{
    ...
    #pragma omp master
    {
        ...
        plasma_omp_dpbsv(uplo, AB, B, &sequence, &request);
 ...
 *  Non-blocking tile version of plasma_dpbsv().
