 ...
 *
 ******************************************************************************/
int plasma_dgemm_blasfeo(plasma_enum_t transa, plasma_enum_t transb,
                 int m, int n, int k,
                 ...
                 double beta,  double *pC, int ldc)
{
    ...
    #pragma omp master
    {
        ...
        plasma_omp_dge2desc_blasfeo(pA, lda, A, &sequence, &request);
...
//exit(1);
        ...
        plasma_omp_dgemm_blasfeo(transa, transb,
                         alpha, A,
                                B,
                         beta,  C,
                         &sequence, &request);
 ...
 *
 ******************************************************************************/
void plasma_omp_dgemm_blasfeo(plasma_enum_t transa, plasma_enum_t transb,
