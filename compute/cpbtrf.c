 ...
 *
 * @generated from compute/zpbtrf.c, normal z -> c, Sat Jul 22 09:24:25 2017
 *
 **/
                  ...
                  plasma_complex32_t *pAB, int ldab)
{
    ...
    #pragma omp master
    {
        ...
        plasma_omp_cpbtrf(uplo, AB, &sequence, &request);
 ...
 *  matrix.
 *  Non-blocking tile version of plasma_cpbtrf().
