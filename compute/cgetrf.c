 ...
 *
 * @generated from compute/zgetrf.c, normal z -> c, Sat Jul 22 09:24:25 2017
 *
 **/
                  ...
                  plasma_complex32_t *pA, int lda, int *ipiv)
{
    ...
    // Tune parameters.
    if (plasma->tuning)
        plasma_tune_getrf(plasma, PlasmaComplexFloat, m, n);
    ...
    #pragma omp master
    {
        ...
        plasma_omp_cgetrf(A, ipiv, &sequence, &request);
