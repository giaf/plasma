 ...
 *
 * @generated from compute/zhetrs.c, normal z -> d, Sat Jul 22 09:24:23 2017
 *
 **/
 ...
 *
 ******************************************************************************/
int plasma_dsytrs(plasma_enum_t uplo, int n, int nrhs,
                  double *pA, int lda,
                  int *ipiv,
                  double *pT, int ldt,
                  int *ipiv2,
                  double *pB,  int ldb)
{
    ...
    #pragma omp master
    {
        ...
        plasma_omp_dsytrs(uplo, A, ipiv, T, ipiv2, B, &sequence, &request);
    }
 ...
 *  Non-blocking tile version of plasma_dsytrs().
