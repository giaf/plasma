 ...
 *
 * @generated from compute/zgeqrs.c, normal z -> s, Sat Jul 22 09:24:33 2017
 *
 **/
                  ...
                  float *pB, int ldb)
{
    ...
    #pragma omp master
    {
        ...
        plasma_omp_sgeqrs(A, T, B, work, &sequence, &request);
 ...
 *  Non-blocking tile version of plasma_sgeqrs().
