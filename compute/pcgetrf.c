 ...
 *
 * @generated from compute/pzgetrf.c, normal z -> c, Sat Jul 22 09:24:13 2017
 *
 **/
                ...
                for (int rank = 0; rank < num_panel_threads; rank++) {
                    {
                        ...
                        core_cgetrf(view, &ipiv[k*A.mb], ib,
