 ...
 *
 * @generated from compute/zpbtrs.c, normal z -> s, Sat Jul 22 09:24:32 2017
 *
 **/
                  ...
                  float *pB,  int ldb)
{
    ...
    // Tune parameters.
    if (plasma->tuning)
        plasma_tune_trsm(plasma, PlasmaRealFloat, n, n);
    ...
    #pragma omp master
    {
        ...
        plasma_omp_spbtrs(uplo, AB, B, &sequence, &request);
 ...
 *  Non-blocking tile version of plasma_spbtrs().
