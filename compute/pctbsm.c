 ...
 *
 * @generated from compute/pztbsm.c, normal z -> c, Sat Jul 22 09:24:12 2017
 *
 **/
        ...
        if (uplo == PlasmaUpper) {
            if (trans == PlasmaNoTrans) {
                ...
                for (int k = 0; k < B.mt; k++) {
                    ...
                    plasma_complex32_t lalpha = k == 0 ? alpha : 1.0;
                ...
                for (int k = 0; k < B.mt; k++) {
                    ...
                    for (int n = 0; n < B.nt; n++) {
                        ...
                        if (ipiv != NULL) {
                            ...
                            #pragma omp taskwait
                            if (sequence->status == PlasmaSuccess) {
                                core_cgeswp(PlasmaRowwise, view, k*A.nb+1, k*A.nb+mvbk, ipiv, 1);
                            }
                        }
                        core_omp_ctrsm(
                            side, uplo, trans, diag,
